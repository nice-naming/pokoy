...
export const fibNumToStyleSheetVarMap = {
  ...
  [FIB_NUMS_FOR_TIMER[8]]: FIB_STYLE_SHEET_COLORS_NAMES[8],
  [FIB_NUMS_FOR_TIMER[9]]: FIB_STYLE_SHEET_COLORS_NAMES[9],
  [FIB_NUMS_FOR_TIMER[10]]: FIB_STYLE_SHEET_COLORS_NAMES[10],
}
